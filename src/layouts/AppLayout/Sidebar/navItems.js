...
export const NAV_ITEMS = [
  { type: 'link', to: ROUTES.dashboard, label: 'Painel geral', icon: DashboardIcon, end: true },
  {
    ...
    items: [
      ...
      { to: ROUTES.chamadosDashboard, label: 'Indicadores', icon: DonutChartIcon },
    ],
  },
  {
    type: 'group',
    ...
    items: [
      { to: ROUTES.ativos, label: 'Ativos cadastrados', icon: TagIcon },
  ...
  },
  {
    ...
    icon: RouterIcon,
    items: [
      { to: ROUTES.infraestrutura, label: 'Infraestrutura', icon: ServerIcon },
      { to: ROUTES.monitoramento, label: 'Monitoramento', icon: NetworkMonitorIcon },
      { to: ROUTES.monitoramentoPainel, label: 'Painel de Infra', icon: GaugeIcon },
    ],
  },
  {
    type: 'group',
  ...
  },
  {
    ...
    label: 'Pessoas',
    icon: ContactsIcon,
    items: [{ to: ROUTES.contatos, label: 'Contatos', icon: ContactCardIcon }],
  },
  {
    type: 'group',
    key: 'dados',
